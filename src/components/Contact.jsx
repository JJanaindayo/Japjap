    ...
    <section className='bg-[#F2F2F2] p-22' id='Contact'>
        ...
        <div className='flex flex-row pt-16'>
            <div className='flex flex-col items-center text-center'>
              <span><img src="\assets\email-icon.jpg" alt="" className='w-10 mb-3'/></span>
            ...
            <div className='flex flex-col items-center text-center'>
              <span><img src="\assets\facebook-logo.avif" alt="" className='w-10 rounded-4xl mb-3'/></span>
            ...
            <div className='flex flex-col items-center text-center'>
              <span><img src="\assets\instagram-logo.avif" alt="" className='w-10 rounded-4xl mb-3'/></span>
